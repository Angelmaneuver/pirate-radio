...
pkgdeplist=( "vlc-nox" "libxml2" "libxslt" ) # list of dependencies
pkgdeplist_buster=( "vlc-bin" "vlc-plugin-base" "libxml2" "libxslt" ) # vlc-nox not in buster
...
pip_req() {
    PIP_CHK=$(pip show "$1" 2>&1 | grep "not found")
